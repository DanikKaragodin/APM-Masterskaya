...
namespace BD5
{
    public partial class DefectsTable : Form
    {
        public DefectsTable()
        {
            InitializeComponent();
        ...
        {
            неисправностьСЗапчастямиBindingSource.Filter = "Описание='" + comboBox1.Text + "'";
        }

        private void button3_Click(object sender, EventArgs e)
        {
            неисправностьСЗапчастямиBindingSource.Filter = "";
        }
